...
local Window = Rayfield:CreateWindow({
    Name = "Monzz Scriptz",
    LoadingTitle = "Monzz Visiual...",
    LoadingSubtitle = "by Monzz",
    ConfigurationSaving = {
        Enabled = false,
        FolderName = "Monzz", -- Create a custom folder for your hub/game
        FileName = "Monzz Hub"
    },
    Discord = {
        Enabled = true,
    ...
    KeySettings = {
        Title = "Monzz Scriptz",
        Subtitle = "Key System",
        Note = "Join the discord (discord.gg/4y4CZfdJHu)",
        FileName = "Monzz Hub",
        SaveKey = false,
